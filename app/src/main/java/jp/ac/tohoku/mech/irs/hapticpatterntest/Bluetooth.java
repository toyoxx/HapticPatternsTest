...
public class Bluetooth {
	 ...
	 * @param out
	 *            The bytes to write
	 * @see jp.ac.tohoku.mech.irs.hapticpatterntest.Bluetooth.ConnectedThread#write(byte[])
     *
	 */
	...
	private class ConnectThread extends Thread {
		...
		public ConnectThread(BluetoothDevice device) {
            ...
            /*catch (IOException e) {
                ...
                Log.e(TAG, "Yet another exception: ", e);
            }
			mmSocket = tmp;
		}
			...
			while (true) {
				try {
                    ...
                    if (endOfLineIndex > 0) {
                        ...
                        if (D)
                            Log.d(TAG, "message buffer " + sbprint);

                        // Send the obtained bytes to the UI Activity
                        mHandler.obtainMessage(MESSAGE_READ, bytes,-1, sbprint).sendToTarget();
                    }
    ...
    public void connectDevice(String deviceName) {
        ...
        try {
            ...
            Log.e(TAG, "Unable to connect to device "+e.getMessage());
        }
